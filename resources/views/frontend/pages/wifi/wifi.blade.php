...
<div class=""></div>
<div
    class="relative m-2 h-[calc(100%_-_10px)] w-[calc(100%_-_10px)] overflow-hidden"
>
    <button id="submit-btn" class="btn bg-blue-400 p-4">tesst</button>
</div>
<script>
