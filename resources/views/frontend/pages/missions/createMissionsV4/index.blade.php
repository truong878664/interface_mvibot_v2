...
@section('content')
    ...
    <div class="relative h-full w-full lg:p-1">
        ...
        <div class="absolute top-0 z-2 pt-2 pr-2" id="action-history">
            <button data-action-history="undo" class="btn h-8 w-8 rounded-md border border-stone-400 bg-white px-2">
            ...
            <button data-action-history="redo" class="btn h-8 w-8 rounded-md border border-stone-400 bg-white px-2">
                <svg width="100%" height="100%" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div class="h-full w-full">
            ...
            <div class="relative flex h-full w-full z-1">
                ...
                <div
                    class="absolute right-0 bottom-0 h-full w-0 overflow-hidden rounded-lg bg-white opacity-0 z-1 transition-all peer-checked/step-wrapper:w-full peer-checked/step-wrapper:opacity-100 xl:relative xl:peer-checked/step-wrapper:w-1/4">
