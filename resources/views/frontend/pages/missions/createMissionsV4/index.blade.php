...
@section('content')
    ...
    <div class="w-full lg:w-[calc(100%_-_10px)] h-[calc(100%_-_10px)] lg:m-2 overflow-aut lg:p-4 relative">
        ...
        <div class="absolute top-0 left-20 z-[1]" id="action-history">
            <button data-action-history="undo" class="text-xl border rounded-md border-stone-400 bg-white px-2 btn w-10 h-10">
        ...
        <div class="h-full w-full">
            ...
            <div class="flex w-full h-full relative">
                ...
                <label for="step-wrapper"
                    class="btn rounded-lg px-4 py-2 mx-2 text-2xl absolute top-0 right-0 z-10 hidden peer-checked/step-wrapper:block">
