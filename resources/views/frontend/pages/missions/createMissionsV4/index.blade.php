...
>
    ...
    <div class="h-full w-full">
        ...
        <input
            class=""
            id="type-mission"
            value="{{ $itemRender->type }}"
            hidden
        />
        <div class="relative flex h-full w-full">
            <input
                type="checkbox"
                class="peer/step-wrapper"
                id="step-wrapper"
                hidden
            />
            <div
                class="relative h-full w-full transition-all md:peer-checked/step-wrapper:w-3/4 lg:mr-4"
            >
                <div
                    id="block-step-wrapper"
                    class="inline-flex h-full w-full flex-wrap content-start items-start gap-4 overflow-y-auto pb-72 pt-10"
                >
                    <button
            ...
            <label
                for="step-wrapper"
                class="btn absolute top-0 right-0 z-10 mx-2 hidden rounded-lg px-4 py-2 text-2xl peer-checked/step-wrapper:block"
            >
                <i class="fa-solid fa-xmark"></i>
            </label>

            <div
                class="absolute right-0 bottom-0 h-full w-0 overflow-hidden rounded-lg bg-white opacity-0 transition-all peer-checked/step-wrapper:w-full peer-checked/step-wrapper:opacity-100 xl:relative xl:p-4 xl:peer-checked/step-wrapper:w-1/4"
            >
            ...
            {{--
            <div
                class="hidden h-full w-0 overflow-hidden rounded-lg bg-white p-4 opacity-0 transition-all peer-checked/step-wrapper:w-1/4 peer-checked/step-wrapper:opacity-100"
            >
                @include('frontend.pages.missions.createMissionsV4.partials.function.function')
            </div>
            --}}
