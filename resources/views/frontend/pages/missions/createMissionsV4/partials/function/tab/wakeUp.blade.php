<div class="flex relative h-full w-full flex-col bg-[#fff] p-4" data-type="wakeup">
    <div class="mb-4 flex">
    ...
    <div class="group flex h-full w-full flex-col justify-center">
        <div class="my-3 ml-2 hidden items-center peer-checked/module:group-[]:flex">
            <label for="" class="mr-3 text-xl">Name GPIO module</label>
            <select class="input-reset valid-input h-[24.5px] w-[200px] border bg-[#fff] px-4 py-1 text-xl outline-none"
                name="name_gpio" id="">
