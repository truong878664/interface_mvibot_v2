<div class="flex h-full w-full justify-between hidden marker-item" data-type-marker="none_marker_angle">
    <div class="w-1/2 ">
        ...
        <div class="flex">
            ...
            <div class="flex flex-col mr-2 items-center">
                ...
                <input class="w-[54px] text-xl px-4 py-1 offset-s-001 input-type-number" type="text" required value="0.01"
                    step="0.01" name="sx1">
            </div>
