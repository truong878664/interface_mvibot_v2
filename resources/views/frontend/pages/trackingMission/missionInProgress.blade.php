<div class="absolute left-0 bottom-0 -mb-1 text-[16px] rounded-lg max-w-[70%] w-full max-h-[90%] flex flex-col">
    ...
    <div
        class="scrollbar-hide w-full bg-white/10 [&_[data-name='icon-block']]:bg-transparent [&_[data-name='step']]:bg-white/90 [&_[data-name='step']]:p-1 [&_[data-name='step']]:py- [&_.wrap-block]:bg-white/20 [&_[data-block-wrapper]]:bg-white/20 overflow-auto max-h-0 group peer-checked/progress:max-h-[1000px] peer-checked/hidden-progress:max-h-0 transition-all duration-500">
