<div class="absolute left-0 bottom-0 -mb-1 text-[16px] rounded-lg max-w-[70%] w-full max-h-[90%] flex flex-col">
    ...
    <div class="flex group">
        <label
            class="bg-white/90 px-8 rounded-tl-lg rounded-tr-3xl cursor-pointer border-stone-500 text-black/40 border peer-checked/progress-main:group-[]:bg-main/80 peer-checked/progress-main:group-[]:text-white peer-checked/progress-main:group-[]:border-transparent"
            for="progress-main">Progress</label>
        <label
            class="bg-white/90 px-8 rounded-tl-lg rounded-tr-3xl cursor-pointer border-stone-500 text-black/40 border peer-checked/local-variable:group-[]:bg-main/80 peer-checked/local-variable:group-[]:text-white peer-checked/local-variable:group-[]:border-transparent active"
            for="local-variable">
            Local variable</label>
        <label
            class="bg-white/90 px-8 rounded-tl-lg rounded-tr-3xl cursor-pointer border-stone-500 text-black/40 border peer-checked/mission-memory:group-[]:bg-main/80 peer-checked/mission-memory:group-[]:text-white peer-checked/mission-memory:group-[]:border-transparent"
            for="mission-memory">
            Mission memory</label>
        <label
            class="bg-white/90 px-8 hover:text-main rounded-tl-lg rounded-tr-3xl cursor-pointer border-stone-500 text-black/40 border peer-checked/hidden-progress:group-[]:bg-main/80 peer-checked/hidden-progress:group-[]:text-white peer-checked/hidden-progress:group-[]:border-transparent peer-checked/hidden-progress:group-[]:hidden"
            for="hidden-progress"><i class="fa-solid fa-sort-down"></i></label>
    </div>
    <div class="flex flex-col text-2xl" id="info-progress"></div>
    <div
        ...
        <div class="p-4 hidden peer-checked/progress-main:group-[]:flex flex-wrap gap-4">
            <div data-status=""
