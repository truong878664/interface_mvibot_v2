        ...
        <div class="h-full flex flex-col bg-[#ccc] relative overflow-hidden rounded-md">
            ...
            <div class="absolute m-4 px-2 rounded-sm flex items-center">
                ...
                {{-- <label class="text-[#fff] bg-[#0f6cbd] text-2xl px-2 py-2 rounded-md">
                    ...
                    @include('frontend/blocks/selection', ['title'=> "Choose map", 'id'=> "choose-map-active", 'datas' => $newMap, 'nameArray' => 'name'])
                {{-- </label> --}}
                <div class="mx-4">
                    <button class="bg-[#0f6cbd] text-[#fff] px-3 py-2 rounded-md text-2xl btn font-bold"
                        id="active-map-btn">Active map</button>
                    <button
                        class="bg-red-500 text-[#fff] px-3 py-2 rounded-md text-2xl btn font-bold delete-map-active-btn">Delete
                        map</button>
                </div>
                <input type="checkbox" name="" class="peer/delete-map hidden" id="delete-map">
                <label for="delete-map"
                    class="fixed top-0 z-10 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.2)] hidden peer-checked/delete-map:flex justify-center items-center">
                    <div class="p-4 bg-[#fff] rounded-md flex flex-col justify-center text-2xl">
                        <p>Do you want to delete this map?</p>
                        <div class="flex justify-evenly mt-4">
                            <label for="delete-map"
                                class="bg-yellow-500 text-[#fff] px-3 py-2 rounded-md btn">Cancel</label>
                            <label for="delete-map" class="bg-red-500 text-[#fff] px-3 py-2 rounded-md btn"
