...
<div
    class="m-2 flex h-[calc(100%_-_10px)] w-[calc(100%_-_10px)] flex-col overflow-hidden rounded-md bg-stone-200"
>
    <div class="flex h-full flex-col">
        <div class="flex flex-1">
            <div class="relative h-full w-5/6 overflow-hidden">
                <div
                    class="absolute h-full w-full cursor-copy overflow-hidden rounded-md"
                    id="map"
                ></div>
                {{-- ===heading map=== --}}
                <div class="absolute flex w-full p-2 text-[1.5rem]">
                    <div class="text-xl">
                    ...
                    <div class="absolute top-3 right-3 w-[200px] bg-[#fff]">
                        ...
                        >
                            ...
                            <span
                                class="float-right pr-4 text-xl leading-[23px]"
                            >
                                <i
                                    class="fa-solid fa-chevron-down hidden"
                                    id="down-icon"
                                ></i>
                                <i
                                    class="fa-solid fa-chevron-up hidden"
                                    id="up-icon"
                                ></i>
                            </span>
                        </label>
                        @php $allLayerJson = json_encode($allLayer->toArray());
                        @endphp
                        <input
                            type="hidden"
                            value="{{ $allLayerJson }}"
                        ...
                        />
                        <div
                            class="mt-[23px] hidden max-h-[300px] overflow-scroll overflow-x-hidden"
                            id="list-layer-item"
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    @csrf --}}
                                    <button
                                        class="text-[rgba(51,51,51,0.38)] hover:text-[#333]"
                                    >
                                        {{--
            ...
            <div
                class="mt-3 flex w-[300px] flex-col content-start justify-end rounded-md px-5"
            >
                <div class="">
                    <div for="" class="relative mb-9 w-full text-[1.4rem]">
                        ...
                        <span
                            class="absolute bottom-0 right-0 block w-full translate-y-full text-right text-[1.2rem] text-red-500"
                            id="msg-name-layer"
                        ></span>
                    </div>
                    ...
                    <div
                        for=""
                        class="mb-9 flex w-full items-center text-[1.4rem]"
                    >
                        <span class="min-w-[77px] pr-2">Type layer</span>
                        <select
                            name=""
                            id="type-layer"
                            class="w-[200px] flex-1 border-[1px] px-4 outline-none"
                        >
                    ...
                    >
                        ...
                        <div class="flex flex-1 flex-col">
                            <input
                                type="number"
                                class="w-[200px] flex-1 px-4"
                                value="1"
                                id="width-layer"
                            />
                            <input
                                id="width-layer-range"
                                type="range"
                                step="0.1"
                                value="0.1"
                                max="50"
                ...
                {{-- ===list layer=== --}}
                <div
                    class="relative mt-10 flex-1 overflow-hidden border-[1px] border-solid border-[#ccc]"
                    id="list-layer-wrapper"
                >
                    <label
                        class="absolute block h-[30px] w-full bg-[rgba(204,204,204,0.51)] text-center"
                        >list layer</label
                    >
                    <div
                        class="mt-[30px] max-h-[300px] overflow-x-auto overflow-y-visible"
                        id="layer-container"
                    >
                        <div
                            class="flex select-none justify-between px-8 py-3 hover:bg-[#cccccc25]"
                        >
                            <button
                                class="delete-layer-btn px-2 text-[rgba(51,51,51,0.34)] hover:text-[#333]"
                            ></button>
                        </div>
                    </div>
                    ...
                    <div class="absolute bottom-0 right-0">
                        ...
                        >
                            ...
                            @csrf
                            <button
                                class="btn m-4 bg-[#0f6cbd] px-4 text-[#fff]"
                                id="save-layer-btn"
                            >
                                Save
                            </button>
