...
>
    <div class="absolute top-0 left-0 min-h-[40px] p-2">
        <div
            class="flex h-full rounded-md border bg-white shadow-md backdrop-blur-sm"
        >
            <label>
                <input
                    type="checkbox"
                    class="peer/select sr-only"
                    id="create-layer"
                />
                <div
                    class="flex items-center gap-2 rounded-md px-3 py-2 text-2xl text-black peer-checked/select:bg-stone-200"
                >
