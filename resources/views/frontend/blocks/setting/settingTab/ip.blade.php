    ...
    <div class="mx-auto inline-flex items-center justify-center p-8 border-stone-300 border bg-stone-200">
        <div class="w-full">
            <div class="w-full mb-10">
                <input type="text" class="mr-4 h-[34px] px-4 tracking-[0.7rem] text-3xl address-ip-master" value="">
                <button
            ...
            <div class="w-full">
                <input type="text" class="mr-4 h-[34px] px-4 tracking-[0.7rem] text-3xl address-ip-node" value="">
                <button
