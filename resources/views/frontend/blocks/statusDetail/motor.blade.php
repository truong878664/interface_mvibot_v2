...
<div class="flex flex-col mx-6">
    ...
    <div class="flex flex-col motor_left">
        <span data-parameter-status="" data-parameter-title="motor"
            class="py-2 h-[30px] text-2xl pr-8 pl-2 live ">-</span>
        <span data-parameter-status="" data-parameter-title="motor"
            class="py-2 h-[30px] text-2xl pr-8 pl-2 error [&.yes]:!text-red-600 [&.no]:!text-green-600">-</span>
        <span data-parameter-status="" data-parameter-title="motor"
            class="py-2 h-[30px] text-2xl pr-8 pl-2 enable">-</span>
        <span data-parameter-status="" data-parameter-title="motor"
            class="py-2 h-[30px] text-2xl pr-8 pl-2 brake">-</span>
    </div>
    <span class="py-2 h-[30px] text-2xl pr-8 pl-2 text-transparent">-</span>
