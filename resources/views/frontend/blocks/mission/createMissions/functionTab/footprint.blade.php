        ...
        <div class="w-[22%]">
            <div class="mr-4">
                ...
                <input required type="text" placeholder="m"
                    class="w-[50px] text-xl px-2 py-1 text-center placeholder:text-xl input-type-number input-reset"
                    step="0.01" name="x1_footprint" value="">
            </div>
            ...
            <div class="mr-4 ">
                ...
                <input required type="text" placeholder="m"
                    class="w-[50px] text-xl px-2 py-1 text-center placeholder:text-xl input-type-number input-reset"
                    step="0.01" name="x2_footprint" value="">
            </div>
            ...
            <div class="mr-4 ">
                ...
                <input required type="text" placeholder="m"
                    class="w-[50px] text-xl px-2 py-1 text-center placeholder:text-xl input-type-number input-reset"
                    step="0.01" name="y1_footprint" value="">
            </div>
            ...
            <div class="mr-4">
                ...
                <input required type="text" placeholder="m"
                    class="w-[50px] text-xl px-2 py-1 text-center placeholder:text-xl input-type-number input-reset"
                    step="0.01" name="y2_footprint" value="">
            </div>
            <div class="mr-4">
                <button
