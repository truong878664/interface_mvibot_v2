<form class="flex h-full w-full justify-between marker-item" action="/dashboard/missions/create-marker" method="POST">
    <div class="w-1/2 ">
        <div class="flex items-stretch">
            <div class="flex flex-col mb-2">
                <label for="" class="text-xl">Name Marker</label>
                <input name="name_marker" class="w-[100px] text-xl px-4 py-1" type="text" required>
            </div>
