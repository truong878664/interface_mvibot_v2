<form class="flex h-full w-full justify-between hidden marker-item">
    ...
    <div class="w-1/2 ">
        ...
        <div class="flex">
            ...
            <div class="flex flex-col mr-2 items-center">
                ...
                <input class="w-[54px] text-xl px-4 py-1" value="0.01" step="0.01" required type="number"
                    name="sx1">
            </div>
    ...
    <div class="w-1/2 h-full ">
        <div class="h-full w-full max-w-[400px] bg-contain bg-no-repeat self-center bg-center marker-img"
            markerDir="l_marker_" style="background-image: url('/img/marker/bar_marker_front_ward.png')"></div>
    </div>
