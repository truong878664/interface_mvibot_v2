...
<div class="form-marker-wrapper form-l-marker">
    @include('frontend.blocks.mission.createMissions.createStep.function.tabMarker.formLMarker')
</div>

<div class="form-marker-wrapper form-vl-marker">
    @include('frontend.blocks.mission.createMissions.createStep.function.tabMarker.formVlMarker')
</div>

<div class="form-marker-wrapper form-bar-marker">
    @include('frontend.blocks.mission.createMissions.createStep.function.tabMarker.formBarMarker')
</div>

<div class="form-marker-wrapper form-none-marker-dis">
    @include('frontend.blocks.mission.createMissions.createStep.function.tabMarker.noneMarkerDis')
</div>

<div class="form-marker-wrapper form-none-marker-angle">
    @include('frontend.blocks.mission.createMissions.createStep.function.tabMarker.noneMarkerAngle')
</div>
