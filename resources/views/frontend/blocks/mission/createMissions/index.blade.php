...
@foreach ($missions as $index => $itemMission)
    <div class="create-misisons-item bg-gradient-to-r text-white rounded-md h-24 opacity-90 relative shadow-sm hover:shadow-md {{ $colorMisisonItem[$type] }}"
        ...
        <div class="h-full w-full">
            <a href="/dashboard/missions/{{ $v }}/create-missions/{{ $itemMission->id }}"
                ...
                <input
                    class="text-xl bg-transparent border-[2px] rounded-lg border-transparent p-2 w-full pointer-events-none name-mission"
