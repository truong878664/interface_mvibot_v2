<div id="message-session"
    class="{{ $status }} notification-show group/noti text-white -translate-y-[120%] notification [&.notification-show]:translate-y-0 transition-transform duration-100 [&.error]:text-red-500 [&.success]:text-green-500 fixed top-[10px] left-1/2 -translate-x-1/2 z-[100] bg-[#ffffff] px-4 py-2 min-w-[200px] min-h-[60px] max-h-[120px] rounded-lg flex items-center shadow-md overflow-hidden">
...
<script>
    setTimeout(() => {
        document.querySelector("#message-session")?.remove()
    }, 3000);
</script>
