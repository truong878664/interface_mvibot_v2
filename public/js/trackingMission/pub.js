...
function pub() {
    ...
    setInterval(() => {
        publishTopic(
            ...
            `/Status>Cancel//mission_action_infor>Normal//Normal_mission_infor:(name_mission:HS_0020)(total_step:12)(now_step:${i})(infor_action_step:name:D_1.6_30s|time_out:30|mode:marker|data:~marker_type=none_marker_dis~~off_set_dis=1.6~~sx1=0.05~~sx2=0.15~~sy1=0.05~~sy2=0.25~)/`
        );
        publishTopic(
