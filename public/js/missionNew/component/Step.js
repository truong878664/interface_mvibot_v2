const Step = (step, addressIndex = "") => {
    ...
    const stepItems = {
        footprint: `
        <div draggable="true" data-name="step" data-value="${step}" data-id=${id} data-address-index="${addressIndex}" data-type="footprint" data-action-block-step="step" data-sticky="hidden" class="data-[sticky='show']:z-10 relative cursor-pointer h-[30px] mr-2 mb-2 bg-[#38c3ff33] text-[#38c3ff] rounded-lg inline-flex items-center px-4 text-[16px]">
            <span class="mr-4"><i class="fa-solid fa-arrows-left-right-to-line"></i></span>
            <span>${name}</span>
        </div>`,
        gpio: `
        <div draggable="true" data-name="step" data-value="${step}" data-id=${id} data-address-index="${addressIndex}" data-type="gpio" data-action-block-step="step" data-sticky="hidden" class="data-[sticky='show']:z-10 relative cursor-pointer h-[30px] mr-2 mb-2 bg-[#30C93033] text-[#30C930] rounded-lg inline-flex items-center px-4 text-[16px]">
            <span class="mr-4"><i class="fa-solid fa-microchip"></i></span>
            <span>${name}</span>
        </div>`,
        gpio_module: `
        <div draggable="true" data-name="step" data-value="${step}" data-id=${id} data-address-index="${addressIndex}" data-type="gpio_module" data-action-block-step="step" data-sticky="hidden" class="data-[sticky='show']:z-10 relative cursor-pointer h-[30px] mr-2 mb-2 bg-[#EE5E8B33] text-[#EE5E8B] rounded-lg inline-flex items-center px-4 text-[16px]">
            <span class="mr-4"><i class="fa-solid fa-microchip"></i></span>
            <span>${name}</span>
        </div>`,
        marker: `
        <div draggable="true" data-name="step" data-value="${step}" data-id=${id} data-address-index="${addressIndex}" data-type="marker" data-action-block-step="step" data-sticky="hidden" class="data-[sticky='show']:z-10 relative cursor-pointer h-[30px] mr-2 mb-2 bg-[#432C7A33] text-[#432C7A] rounded-lg inline-flex items-center px-4 text-[16px]">
        ...
        variable: `
        <div draggable="true" data-name="step" data-value="${step}" data-id=${id} data-address-index="${addressIndex}" data-type="variable" data-action-block-step="step" data-sticky="hidden" class="data-[sticky='show']:z-10 relative cursor-pointer h-[30px] mr-2 mb-2 bg-[#EA580C33] text-[#EA580C] rounded-lg inline-flex items-center px-4 text-[16px]">
