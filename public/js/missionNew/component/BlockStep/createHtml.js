...
const createHtml = {
    htmlBlock: {
        normal: `
        <div data-block-wrapper="normal" class="flex w-full shadow-block bg-white p-4 rounded-lg my-4" data-address="{{address}}">
        ...
        `,
        ifelse: `
        <div data-block-wrapper="ifelse" class="flex w-full shadow-block bg-white p-4 rounded-lg my-4" data-address="{{address}}">
        ...
        <div class="flex-1 text-[16px]">
            ...
            <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                ...
                <div class="flex-1 flex flex-wrap" data-data-block="if_">
                   {{if_}}
                    ${buttonAddStep}
                </div>
            </div>
            <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                ...
                <div class="flex-1 flex flex-wrap" data-data-block="else_">
                    {{else_}}
                    ${buttonAddStep}
                </div>
            </div>
        ...
        `,
        trycatch: `
        <div data-block-wrapper="trycatch" class="flex w-full shadow-block bg-white p-4 rounded-lg my-4" data-address="{{address}}">
            ...
            <div class="flex-1 text-[16px]">
                <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                    ...
                    <div class="flex-1 flex flex-wrap" data-data-block="try_">
                        {{try_}}
                        ${buttonAddStep}
                    </div>
                </div>
                <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                    ...
                    <div class="flex-1 flex flex-wrap" data-data-block="catch_">
                        {{catch_}}
                        ${buttonAddStep}
                    </div>
                </div>
        ...
        `,
        while: `
        <div data-block-wrapper="while" class="flex w-full shadow-block bg-white p-4 rounded-lg my-4" data-address="{{address}}">
            ...
            <div class="flex-1 text-[16px]">
                ...
                <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                    ...
                    <div class="flex-1 flex flex-wrap" data-data-block="do_">
                        {{do_}}
                        ${buttonAddStep}
                    </div>
                </div>
        ...
        `,
        logicAnd: `
        <div data-block-wrapper="logic_and" class="inline-flex shadow-block bg-white p-4 rounded-lg my-4 mr-4" data-address="{{address}}">
        ...
        `,
        logicOr: `
        <div data-block-wrapper="logic_or" class="inline-flex shadow-block bg-white p-4 rounded-lg my-4 mr-4" data-address="{{address}}">
            <div class="flex-1 text-[16px] flex">
                <div class="bg-stone-100 p-4 rounded-lg flex mb-3">
                    <div class="flex-1 flex flex-wrap" data-data-block="logicA">
                        {{logicA}}
