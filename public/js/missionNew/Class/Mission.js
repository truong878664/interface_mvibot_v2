...
export default class Mission {
    ...
    render() {
        try {
            ...
            const buttonAddRoot = `<button data-action-block-step="add" class="active-block-step-root btn w-7 h-7 relative flex justify-center text-[16px] rounded-md mb-2 ml-2  items-center text-sky-500 bg-sky-100 self-center [&.active]:bg-sky-800 [&.active]:text-white"><i class="fa-solid fa-plus"></i></button>`;
