            ...
            arraySteps.forEach((arrayStep) => {
                ...
                switch (typeMissionItem[1]) {
                    case "normal":
                        ...
                        html.push(
                            `<i class="fa-solid fa-quote-left"></i> <div class="step-item text-[#333] border border-[#333] bg-white ">normal</div>${htmlNormalText}<i class="fa-solid fa-quote-right mr-7"></i>`
                        );
                        break;
                    case "ifelse":
                        ...
                        htmlIfelse.push(
                            ` <div class="step-item bg-black text-[#fff]">if</div>${htmlIf.join(
                                ""
                            )}`
                        );
                        htmlIfelse.push(
                            ` <div class="step-item bg-black text-[#fff]">then</div>${htmlThen.join(
                                ""
                            )}`
                        );
                        htmlIfelse.push(
                            ` <div class="step-item bg-black text-[#fff]">else</div>${htmlElse.join(
                                ""
                            )}`
                        );
                        html.push(
                            `<i class="fa-solid fa-quote-left"></i>${htmlIfelse.join(
                                ""
