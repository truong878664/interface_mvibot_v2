                    ...
                    <div type-mission-id=${item.id} mission-type="${item.type}"
                        ...
                        <div class="flex">
                            <input type="checkbox" data-select-type-mission-id="${
                                ...
                                item.type
                            }" class="mr-4 w-3 h-3 rounded text-yellow-500 type-mission-item-select">
                        ...
                        <div class="">
                            <button class=" mr-2 h-[30px] w-[30px] bg-white btn rounded-md delete-type-mission-btn shadow-sm shadow-[#ccc]">
                                <i class="fa-solid fa-xmark"></i>
                            </button>

                            <button class=" mr-2 h-[30px] w-[30px] bg-white btn rounded-md edit-type-mission-btn shadow-sm shadow-[#ccc]">
                                <i class="fa-solid fa-pen"></i>
                            </button>

                            <button class=" mr-2 h-[30px] w-[30px] bg-white btn rounded-md add-type-mission-btn shadow-sm shadow-[#ccc]">
