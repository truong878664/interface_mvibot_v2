                    ...
                    !(function (d) {
                        ...
                        function j(a, b) {
                            ...
                            for (var c = 0, e = a.length; c + 1 < e; c++)
                                if ("**" === a[c] && "**" === a[c + 1]) return;
                            for (
                                var f = this.listenerTree, h = a.shift();
                                h !== d;
            ...
            function (a, b, c) {
                function d(a) {
                    ...
                    var h = function (a, b) {
                        return (
                            !(a.secs > b.secs) &&
                            (a.secs < b.secs || a.nsecs < b.nsecs)
                        );
                    };
                    g.subscribe(function (a) {
                        0 === a.stamp.secs && 0 === a.stamp.secs && "" === a.id
                            ? ((b.nextGoal = null),
                              b.currentGoal && b.emit("cancel"))
                            : (b.currentGoal &&
                              a.id === b.currentGoal.goal_id.id
                                  ? b.emit("cancel")
                                  : b.nextGoal &&
                ...
                (d.prototype.__proto__ = j.prototype),
                    (d.prototype.connect = function (a) {
                        if ("socket.io" === this.transportLibrary)
                            ...
                            !this.socket ||
                            this.socket.readyState === e.CLOSED
                        ) {
                            var b = new e(a);
                    ...
                    (d.prototype.getServiceResponseDetails = function (
                        a,
                        b,
                        c
                    ) {
            ...
            function (a, b, c) {
                function d(a) {
                    ...
                    (this.topicTimeout = { secs: c, nsecs: d }),
                        (this.serverName =
                            a.serverName || "/tf2_web_republisher"),
                        (this.repubServiceName =
                            a.repubServiceName || "/republish_tfs"),
                        (this.currentGoal = !1),
                        (this.currentTopic = !1),
                        (this.frameInfos = {}),
                ...
                function d(a) {
                    (this.type = e.URDF_CYLINDER),
                        (this.length = parseFloat(
                            a.xml.getAttribute("length")
                        )),
                        (this.radius = parseFloat(
                            a.xml.getAttribute("radius")
                        ));
                }
                var e = a("./UrdfTypes");
                b.exports = d;
                                ...
                                for (var o = 0; o < n.visuals.length; o++) {
                                    ...
                                    null !== p &&
                                        (void 0 !== this.materials[p.name]
                                            ? (n.visuals[o].material =
                                                  this.materials[p.name])
